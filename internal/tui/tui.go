...
var (
	...
	diffAddStyle   = lipgloss.NewStyle().Foreground(lipgloss.Color("#24292f")).Background(lipgloss.Color("#dafbe1"))
	diffDelStyle   = lipgloss.NewStyle().Foreground(lipgloss.Color("#24292f")).Background(lipgloss.Color("#ffebe9"))
